 ...
 */
final class Version20230516001158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messages ADD role TEXT NOT NULL, CHANGE kine_id kine_id INT DEFAULT NULL, CHANGE patient_id patient_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messages DROP role, CHANGE kine_id kine_id INT NOT NULL, CHANGE patient_id patient_id INT NOT NULL');
